		...
		<section class="col-sm-10 col-md-10 col-lg-10 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
			...
			<div class="row">
				<div class="hidden-xs col-sm-10 col-md-10 col-lg-10 col-centered">
					...
					<div class="row">
						<span class="col-sm-5 col-md-5 col-lg-5 col-sm-offset-1 col-md-offset-1">{{$schedule->name_schedule}}</span>
						<span class="col-sm-1 col-md-1 col-lg-1">@if($schedule->type == 1) Fijo @elseif($schedule->type == 2) Variable @endif</span>
						<span class="col-sm-1 col-md-1 col-lg-1 col-sm-offset-2 col-md-offset-2 pull-text-right"><a href="">Editar</a></span>
						<span class="col-sm-1 col-md-1 col-lg-1 pull-text-right"><a class="borrarHorario" href="/{{Request::segment(1)}}/borrar/{{$schedule->id}}">Borrar</a></span>
					</div>
					@endforeach
				</div>
