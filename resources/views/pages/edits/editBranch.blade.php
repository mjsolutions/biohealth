		...
		<section class="col-sm-10 col-md-10 col-lg-10 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
			...
			<div class="row">
				<div class="hidden-xs col-sm-8 col-md-8 col-lg-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
					{!! Form::open(array('route' => array('sucursales/editar', $branch->id), 'class' => 'form-horizontal', 'role' => 'form' , 'id' => 'submitForm')) !!}
						<div class="shadow-division">
								...
								<div class="col-sm-8 col-md-8 col-lg-8">
									<select value="{{Input::old('empresa')}}" name="empresa" id="empresa" class="form-control">
										<option selected="true" disabled="disabled">Seleccione empresa</option>   
									 	...
									 	<option value="{{$enterprise->id}}" @if($enterprise->id == $branch->enterprise_id) selected @endif>{{$enterprise->name_enterprise}}</option>
									 	@endforeach
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$branch->name_branch}}" name="nombre" type="text" class="form-control" id="nombreSucursal" placeholder="Ejemplo: Sucursal Morelia 1">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="control-label pull-text-left col-sm-2 col-md-2 col-lg-2 col-sm-offset-1 col-md-offset-1" for="direccion">Dirección:</label>
				     			<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$branch->address}}" name="direccion" type="text" class="form-control" id="direccion" placeholder="Ejemplo: Revolución #552 Col. Centro.">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$branch->postalcode}}" name="codigoPostal" type="text" class="form-control" id="codigoPostal" placeholder="Ejemplo: 58000">
								</div>
							</div>
				     			...
				     			<div class="col-sm-8 col-md-8 col-lg-8">
									<select value="{{Input::old('estado')}}" name="estado" id="estado" class="form-control">
										<option selected="true" disabled="disabled">Seleccione estado</option>   
									 	...
									 	<option value="{{$state->id}}" @if($state->id == $branch->state_id) selected @endif>{{$state->nombre}}</option>
									 	@endforeach
									</select>
								</div>
							</div>
				     			...
				     			<div class="col-sm-8 col-md-8 col-lg-8">
									<select value="{{Input::old('municipio')}}" name="municipio" id="municipio" class="form-control">
										...
										@foreach($counties as $county)
									 	<option value="{{$county->id}}" @if($county->id == $branch->county_id) selected @endif>{{$county->nombre}}</option>
									 	@endforeach
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="control-label pull-text-left col-sm-2 col-md-2 col-lg-2 col-sm-offset-1 col-md-offset-1" for="telefono">Telefono:</label>
				     			<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$branch->phone}}" name="telefono" type="text" class="form-control" id="telefono" placeholder="Ejemplo: (443) 123 4567">
								</div>
							</div>
