		...
		<section class="col-sm-10 col-md-10 col-lg-10 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
			...
			<div class="row">
				<div class="hidden-xs col-sm-8 col-md-8 col-lg-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
					{!! Form::open(array('route' => array('permisos/editar', $permission->id), 'class' => 'form-horizontal', 'role' => 'form' , 'id' => 'submitForm')) !!}
						<div class="shadow-division">
							<label class="mtDivision ml15 redIdentifier">Identificación:</label>						
							<div class="form-group">
								<label class="control-label pull-text-left col-sm-2 col-md-2 col-lg-2 col-sm-offset-1 col-md-offset-1" for="permiso">Permiso:</label>
								<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$permission->name}}" name="permiso" type="text" class="form-control" id="permiso" placeholder="Ejemplo: Admin, Propietario">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$permission->display_name}}" name="nombre" type="text" class="form-control" id="nombre" placeholder="Ejemplo: Administrador, Propietario del proyecto">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="control-label pull-text-left col-sm-2 col-md-2 col-lg-2 col-sm-offset-1 col-md-offset-1" for="descripcion">Descripción:</label>
				     			<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{$permission->description}}" name="descripcion" type="text" class="form-control" id="descripcion" placeholder="Ejemplo: Administrador de usuarios">
								</div>
							</div>																					
						</div>
