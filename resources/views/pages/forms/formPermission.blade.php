		...
		<section class="col-sm-10 col-md-10 col-lg-10 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
			...
			<div class="row">
				<div class="hidden-xs col-sm-8 col-md-8 col-lg-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
					{!! Form::open(array('route' => 'permisos/agregar', 'class' => 'form-horizontal', 'role' => 'form' , 'id' => 'submitForm')) !!}
						<div class="shadow-division">
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{Input::old('permiso')}}" name="permiso" type="text" class="form-control" id="permiso" placeholder="Ejemplo: Admin, Propietario">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8 col-md-8 col-lg-8">
									<input value="{{Input::old('nombre')}}" name="nombre" type="text" class="form-control" id="nombre" placeholder="Ejemplo: Administrador, Propietario del proyecto">
								</div>
							</div>
